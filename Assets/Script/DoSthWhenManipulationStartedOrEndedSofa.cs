...
public class DoSthWhenManipulationStartedOrEndedSofa : MonoBehaviour
{
    ...
    public void MoveObjectToDestination()
    {
        ...
        else
        {
            ...
            mainSlider.value = mainSlider.value + 3;
            subSlider.value = subSlider.value + 15;
        }
